...
{if !$selected_section}
    {$selected_section = $smarty.request.selected_section}
{/if}
...
<div id="content_detailed" class="{if !empty($selected_section) && $selected_section !== "detailed"}hidden{/if}"> {* content detailed *}
<fieldset>
...
{assign var="vendor_user" value=fn_revoltp_get_vendor_user($company_data.company_id)}

{if $vendor_user}
<div class="control-group">
    <label class="control-label">Ответственное лицо:</label>
    <div class="controls">
        {$vendor_user.firstname} {$vendor_user.lastname}
    </div>
</div>
...
<div id="content_description" class="{if $selected_section !== "description"}hidden{/if}"> {* content description *}
<fieldset>
...
{if "MULTIVENDOR"|fn_allowed_for}
    ...
    <div id="content_logos" class="{if $selected_section !== "logos"}hidden{/if}">
...
<div id="content_regions" class="{if $selected_section !== "regions"}hidden{/if}">
    <fieldset>
        <div class="control-group">
            <div class="controls">
...
<div id="content_shipping_methods" class="{if $selected_section !== "shipping_methods"}hidden{/if}">
...
<div id="content_addons" class="{if $selected_section !== "addons"}hidden{/if}">
...
{/capture}
{include file="common/tabsbox.tpl" content=$smarty.capture.tabsbox group_name="companies" active_tab=$selected_section track=true}
